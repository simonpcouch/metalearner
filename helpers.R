...
# returns the number of workers to use when resampling models. i set
# this to the number of physical cores on my machine, but overwrite
# with `parallelly::availableCores()` or your helper of choice.
#
